...
namespace Olbrasoft.Text.Translation.Google.Tests;

public class GoogleFreeTranslatorTests
{
    private readonly Mock<ILogger<GoogleFreeTranslator>> _loggerMock = new();

    private GoogleFreeTranslator CreateTranslator(
        ...
        string? userAgent = null)
    {
        ...
        return new GoogleFreeTranslator(settings, _loggerMock.Object);
    }
    ...
    public async Task TranslateAsync_EnglishToCzech_ReturnsTranslation()
    {
        ...
        // Google should translate "Hello, how are you?" to something like "Ahoj, jak se máš?"
